#!/usr/bin/env python3
"""Batch face detection v4 - correct ML endpoint."""
import requests
import json
import sqlite3
import sys
...
def main():
    ...
    for i, photo in enumerate(image_photos):
        ...
        if (i+1) % 50 == 0:
            print(f"Progress: {i+1}/{len(image_photos)}, faces={total_faces}, errors={errors}, skipped={skipped}")
